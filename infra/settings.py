...
class Settings:
    ...
    wren_engine_url: str = os.getenv("WREN_ENGINE_URL", "http://wren-engine:8080")
    wren_ai_service_url: str = os.getenv("WREN_AI_SERVICE_URL", "http://wren-ai-service:5555")
    mindsdb_api_url: str = os.getenv("MINDSDB_API_URL", "http://mindsdb:47334/api/sql")
